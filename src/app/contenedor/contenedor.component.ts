...
export class ContenedorComponent implements OnInit {
  ...
  async agregarLibroABiblioteca(){ /*esta es la funcion que se comunica con el emitter de nuevolibro.ts y que me manda  ese NUEVO LIBRO  */
    ...
    //this.lista.push(nuevoLibro);agrego el libro a la lista que va a recibir  la LIBRERIA.TS es donde se mostraran los libros que cargue
    //console.log(nuevoLibro);veo el libro por consola
